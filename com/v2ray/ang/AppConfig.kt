...
object AppConfig {
    ...
    const val HAMEDVPNS_SUB_URL = "https://raw.githubusercontent.com/hamedp-71/N_sub_cheker/refs/heads/patch-1/final.txt"
    const val HAMEDVPNS_SUB_REMARKS = "hamedvpns"
    const val HAMEDVPNS_TEST_BATCH_SIZE = 20
    const val HAMEDVPNS_TG_CHANNEL_URL = "https://t.me/hamedvpns"
    const val PREF_HAMEDVPNS_LAUNCH_COUNT = "pref_hamedvpns_launch_count"
    const val HAMEDVPNS_TG_PROMPT_MAX_SHOWN = 3
